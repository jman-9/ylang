...
static bool Init()
{
	...
	s_tokenStrMap[EToken::This] = "this";
...
{
	return tok == EToken::Int || tok == EToken::Float || tok == EToken::Str || tok == EToken::RawStr || tok == EToken::Null || tok == EToken::True || tok == EToken::False || tok == EToken::This;
}
